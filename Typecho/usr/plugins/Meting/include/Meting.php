...
class Meting
{
    ...
    public function song($id)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://h5api.m.xiami.com/h5/mtop.alimusic.music.songservice.getsongdetail/1.0/',
                'body'   => array(
                    'data' => array(
                        'songId' => $id,
                    ),
    ...
    public function album($id)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://h5api.m.xiami.com/h5/mtop.alimusic.music.albumservice.getalbumdetail/1.0/',
                'body'   => array(
                    'data' => array(
                        'albumId' => $id,
                    ),
    ...
    public function artist($id, $limit = 50)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://h5api.m.xiami.com/h5/mtop.alimusic.music.songservice.getartistsongs/1.0/',
                'body'   => array(
                    'data' => array(
                        'artistId' => $id,
                        'pagingVO' => array(
    ...
    public function playlist($id)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://h5api.m.xiami.com/h5/mtop.alimusic.music.list.collectservice.getcollectdetail/1.0/',
                'body'   => array(
                    'data' => array(
                        'listId'     => $id,
                        'isFullTags' => false,
    ...
    public function lyric($id)
    {
        switch ($this->server) {
            ...
            $api = array(
                'method' => 'GET',
                'url'    => 'https://h5api.m.xiami.com/h5/mtop.alimusic.music.lyricservice.getsonglyrics/1.0/',
                'body'   => array(
                    'data' => array(
                        'songId' => $id,
                    ),
    ...
    private function curlset()
    {
        switch ($this->server) {
            ...
            case 'xiami':
            return array(
                'Referer'    => 'https://h5api.m.xiami.com/',
